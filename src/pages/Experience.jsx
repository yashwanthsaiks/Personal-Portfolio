...
import codeAlphaImg from "@/assets/experience/Advingosys.png";
import bharatInternImg from "@/assets/experience/Mockello.png";

import codeAlphaPdf from "@/assets/files/experience_pdf/Advingosys.pdf";
import bharatInternPdf from "@/assets/files/experience_pdf/Mockello.pdf";


const experiences = [
  {
    title: "Software Engineering Intern",
    company: "Advingosys IT",
    location: "Remote",
    ...
    description: [
      "Designed and deployed a scalable Java Full Stack web application using Spring Boot, React, MySQL, and AWS services (EC2, S3, RDS).",
      "Integrated AI-powered NLP chatbots for real-time automation while following Agile practices and collaborating through Jira, Slack, and Zoom.",
    ],
  },
  {
    ...
    description: [
      "Built and deployed a scalable AI-powered campus placement platform using React, FastAPI, AWS (EC2, S3, RDS), and LiveKit to connect students, colleges, and recruiters.",
      "Implemented role-based recruitment workflows with AI-driven aptitude tests, coding assessments, interviews, and automated placement management.",
    ],
  },
];
