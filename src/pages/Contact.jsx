...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: <Mail className="w-5 h-5" />, label: 'Email', value: 'yashwanth123ks@gmail.com', link: 'mailto:yashwanth123ks@gmail.com' },
    { icon: <Phone className="w-5 h-5" />, label: 'Phone', value: '+918925109543', link: 'tel:+918925109543' },
    { icon: <MapPin className="w-5 h-5" />, label: 'Location', value: 'Chennai, Tamil Nadu, India' },
    { icon: <Clock className="w-5 h-5" />, label: 'Time Zone', value: 'IST (UTC+5:30)' },
  ]

  const socialLinks = [
    { icon: <Github className="w-5 h-5" />, label: 'GitHub', link: 'https://github.com/yashwanthsaiks' },
    { icon: <Linkedin className="w-5 h-5" />, label: 'LinkedIn', link: 'https://www.linkedin.com/in/yashwanth-sai-k-s-82a89a348/' },
    { icon: <MessageCircle className="w-5 h-5" />, label: 'WhatsApp', link: 'https://wa.me/+918925109543' },
  ]
