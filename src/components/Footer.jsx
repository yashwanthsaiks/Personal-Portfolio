      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">Yashwanth sai</span>
            </Link>
            <p className="text-sm text-gray-400">
              Software Developer based in Chennai, TN, India.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  aria-label="Email Yashwanth sai"
                >
                  <Mail className="w-4 h-4" aria-hidden="true" />
                  yashwanth123ks@gmail.com
                </a>
              </li>
              <li>
                <a
                  href="tel:+918925109543"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Call Yashwanth sai"
                >
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Yashwanth sai. All rights reserved.
            </p>
